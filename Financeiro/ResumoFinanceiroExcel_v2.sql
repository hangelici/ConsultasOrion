...
SELECT
       ...
       --  CAST(COALESCE((PDUPREC.VALOR - (PDUPREC.VALOR - COALESCE(PDUPREC.DESCONTO,0) - COALESCE(BAIXAS_DUPREC.VLR,0)) -COALESCE(PDUPREC.DESCONTO,0) ),0)AS NUMERIC(14,2)) RECEBIDO, 
        ...
        COALESCE(PDUPREC.DTBASEJUROS,PDUPREC.DTVENCTO),cast(:DTRECBTO as date), PCONFPAD.TIPOJUROS)
        ELSE 
        ...
        CAST(NVLF0(REPLACE(NVL(:JUROS,0), ',', '.')) AS NUMERIC(14,2)),
        COALESCE(PDUPREC.DTBASEJUROS,PDUPREC.DTVENCTO),cast(:DTRECBTO as date), PCONFPAD.TIPOJUROS) END JUROS,
         ...
         cast(:DTRECBTO as date), COALESCE(PDUPREC.DTVENCTO,PDUPREC.DTBASEJUROS), PCONFPAD.TIPOJUROS)) DESCTO,
        ...
        COALESCE(PDUPREC.VALOR,0) + 
            ...
            COALESCE(CASE WHEN COALESCE((PDUPREC.VALOR - COALESCE(BAIXAS_DUPREC.DESCONTO,0) - COALESCE(BAIXAS_DUPREC.VLR,0))-COALESCE(BAIXAS_DUPREC.DESCONTO,0),0) < 0 THEN
                ...
                CALCULAJURO(NVLF0(CAST((PDUPREC.VALOR - COALESCE(BAIXAS_DUPREC.DESCONTO,0) - COALESCE(BAIXAS_DUPREC.VLR,0))/*-COALESCE(PDUPREC.DESCONTO,0)*/ AS NUMERIC(14,2))),
                CAST(NVLF0(REPLACE(NVL(:JUROS,0), ',', '.')) AS NUMERIC(14,2)),
                COALESCE(PDUPREC.DTBASEJUROS,PDUPREC.DTVENCTO),cast(:DTRECBTO as date), PCONFPAD.TIPOJUROS) END,0)
            --JUROS--
            ...
            --DESC--        
                COALESCE(COALESCE(BAIXAS_DUPREC.DESCONTO,0)+(CALCULAJURO(NVLF0(CAST((PDUPREC.VALOR - COALESCE(BAIXAS_DUPREC.DESCONTO,0) - COALESCE(BAIXAS_DUPREC.VLR,0)) AS NUMERIC(14,2))),
                                   CASE WHEN CAST(REPLACE(NVL(:DESCTO,0), ',', '.') AS NUMERIC(14,2)) = 0 THEN 0
                                   ELSE CAST(REPLACE(NVL(:DESCTO,0), ',', '.') AS NUMERIC(14,2)) END,
                 cast(:DTRECBTO as date), COALESCE(PDUPREC.DTVENCTO,PDUPREC.DTBASEJUROS), PCONFPAD.TIPOJUROS)),0)
            --DESC--
       ...
       CALCULAJURO(NVLF0(CAST((PDUPREC.VALOR - COALESCE(BAIXAS_DUPREC.DESCONTO,0) - COALESCE(BAIXAS_DUPREC.VLR,0)) AS NUMERIC(14,2))),
                                 ...
                                 cast(:DTRECBTO as date), COALESCE(PDUPREC.DTVENCTO,PDUPREC.DTBASEJUROS), PCONFPAD.TIPOJUROS)))
...
UNION ALL
 ...
 SELECT
        ...
        (cast(:DTRECBTO as date) - contamovlan.dtjuro) DIAS,
        ...
        CALCULAJURO(NVLF0(CAST(COALESCE((CONTAMOVLAN.VALOR - COALESCE(CONTAMOVLAN.DESCONTO,0) - COALESCE(BAIXAS_CONTAMOV.VLR,0)),0) AS NUMERIC(14,2))),
                          CAST(NVLF0(REPLACE(NVL(:JUROS,0), ',', '.')) AS NUMERIC(14,2)),
                          CONTAMOVLAN.DTJURO,
                          COALESCE(cast(:DTRECBTO as date),contamovlan.dtjuro), 'S') JUROS,

        CALCULAJURO(NVLF0(CAST(COALESCE((CONTAMOVLAN.VALOR - COALESCE(CONTAMOVLAN.DESCONTO,0) - COALESCE(BAIXAS_CONTAMOV.VLR,0)),0) AS NUMERIC(14,2))),
                           CAST(REPLACE(NVL(:DESCTO,0), ',', '.') AS NUMERIC(14,2)),
                           cast(:DTRECBTO as date), contamovlan.dtjuro, 'S') DESCTO,
       ...
       (COALESCE((CONTAMOVLAN.VALOR - COALESCE(CONTAMOVLAN.DESCONTO,0) - COALESCE(BAIXAS_CONTAMOV.VLR,0)),0) +
        ...
        CALCULAJURO(NVLF0(CAST(COALESCE((CONTAMOVLAN.VALOR - COALESCE(CONTAMOVLAN.DESCONTO,0) - COALESCE(BAIXAS_CONTAMOV.VLR,0)),0) AS NUMERIC(14,2))),
                          CAST(NVLF0(REPLACE(NVL(:JUROS,0), ',', '.')) AS NUMERIC(14,2)),
                          CONTAMOVLAN.DTJURO,
                          COALESCE(cast(:DTRECBTO as date),contamovlan.dtjuro), 'S') -

        CALCULAJURO(NVLF0(CAST(COALESCE((CONTAMOVLAN.VALOR - COALESCE(CONTAMOVLAN.DESCONTO,0) - COALESCE(BAIXAS_CONTAMOV.VLR,0)),0) AS NUMERIC(14,2))),
                           CAST(REPLACE(NVL(:DESCTO,0), ',', '.') AS NUMERIC(14,2)),
                           cast(:DTRECBTO as date), contamovlan.dtjuro, 'S')) SALDOCORR,
       ...
       (COALESCE((CONTAMOVLAN.VALOR - COALESCE(CONTAMOVLAN.DESCONTO,0) - COALESCE(BAIXAS_CONTAMOV.VLR,0)),0) +
        ...
        CALCULAJURO(NVLF0(CAST(COALESCE((CONTAMOVLAN.VALOR - COALESCE(CONTAMOVLAN.DESCONTO,0) - COALESCE(BAIXAS_CONTAMOV.VLR,0)),0) AS NUMERIC(14,2))),
                           CAST(REPLACE(NVL(:DESCTO,0), ',', '.') AS NUMERIC(14,2)),
                           cast(:DTRECBTO as date), contamovlan.dtjuro, 'S'))
...
SELECT
CASE WHEN CONTRATOCFG.ENTRADASAIDA = 'E' THEN '8 - CONTRATO - A PAGAR' ELSE '8 - CONTRATO - A RECEBER' END TIPO,
...
( cast(:DTRECBTO as date) - CONTRATO.DTVENCTO ) DIAS,
...
0 AS JUROS,
0 AS DESCTO,
CASE WHEN CONTRATOCFG.ENTRADASAIDA = 'E' THEN PSALDO.NVLRSALDO * -1 ELSE PSALDO.NVLRSALDO END AS SALDOCORR,
...
( cast(:DTRECBTO as date) - I.DT_VENCTO ) DIAS,
...
AND (F.VALOR_TOTAL_TR - NVL(PDUPREC.DESCPEND,0)) <> NVL(F.VALOR_REC_TR,0)
<#if ESTAB?has_content>
...
'N' AS FRED_FRETE,
F.ESTAB AS EMPRESA,
PDUPREC.DUPREC AS DOC,
cast(:DTRECBTO as date)DTCOB,
PDUPREC.DTEMISSAO,
PDUPREC.DTVENCTO AS DTVENCTO,
COALESCE(PDUPREC.DTCALCJUROS,PDUPREC.DTVENCTO) AS DTCALCJUROS,
( cast(:DTRECBTO as date) - PDUPREC.DTVENCTO ) DIAS,
PDUPREC.CLIENTE AS CLIENTE,
CONTAMOV.GRUPOCM,
CONTAMOV.NOME||' - '||CONTAMOV.NUMEROCM AS NOME,
CONCEITO.DESCRICAO AS CONCEITO,
...
PDUPREC.VALOR,
0 AS JUR,
NVL(PDUPREC.DESCONTO,0) AS "DESC",
NVL(PDUPREC.DESCONTO,0) AS RECEBIDO,
PDUPREC.VALOR AS SALDO,
0 AS JUROS,
0 AS DESCTO,
PDUPREC.VALOR AS SALDOCORR,
CASE WHEN CURRENT_DATE >= PDUPREC.DTVENCTO THEN PDUPREC.VALOR ELSE 0 END SALDOVENCO,
NULL AS IDOCORRENCIA,
NULL AS ROMANEIO,
null AS DTCONTATO,
null AS DTPROXCONTATO,
...
'' AS OBS
FROM PDUPREC 
INNER JOIN FILIAL F ON F.ESTAB = PDUPREC.EMPRESA
INNER JOIN CONTAMOV ON CONTAMOV.NUMEROCM = PDUPREC.CLIENTE
INNER JOIN CONCEITOPESSOA ON CONCEITOPESSOA.NUMEROCM = CONTAMOV.NUMEROCM
INNER JOIN CONCEITO ON CONCEITO.CONCEITO = CONCEITOPESSOA.CONCEITO
LEFT JOIN PSITUACA ON PSITUACA.SITUACAO = PDUPREC.SITUACAO
WHERE
(PDUPREC.VALOR - NVL(PDUPREC.DESCONTO,0)) > 0
AND PDUPREC.DUPREC LIKE 'FT%'
AND PDUPREC.DTEMISSAO BETWEEN NVL(:DTEMIINI,'01/01/2001') AND NVL(:DTEMIFIM,'31/12/2099')
AND PDUPREC.DTVENCTO  BETWEEN NVL(:DTINI,'01/01/2001') AND NVL(:DTFIM,'31/12/2099')
<#if ESTAB?has_content>
    and F.ESTAB IN (:ESTAB)
