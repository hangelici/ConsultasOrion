...
IF UPDATING AND GERADO='N' AND :NEW.statusaprov= '2 - Aprovado' AND :NEW.ESTAB IN (12,26,31)  THEN                                                                            

SELECT SEQITEM,ITEM,LOCAL,DTEMISSAO,QUANTIDADE,VALORUNIT,VALORTOTAL,TIPOSALDO,DTMOVSALDO INTO SEQITEM,ITEM,LOCAL,DTEMISSAO,QUANTIDADE,VALORUNIT,VALORTOTAL,TIPOSALDO,DTMOVSALDO FROM CONTRATOITE
                                                                                         WHERE CONTRATOITE.ESTAB=:NEW.ESTAB
                                                                                         AND CONTRATOITE.CONTRATO=:NEW.CONTRATO;
                                                             
IF ( CONTCONFO = 6) THEN
   INSERT INTO CONTRATOITE (CONTRATOITE.ESTAB,CONTRATOITE.CONTRATO,CONTRATOITE.SEQITEM,CONTRATOITE.ITEM,CONTRATOITE.LOCAL,CONTRATOITE.DTEMISSAO,CONTRATOITE.QUANTIDADE,CONTRATOITE.VALORUNIT,CONTRATOITE.VALORTOTAL,
