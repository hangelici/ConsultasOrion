 ...
 V_DOC := 'AFGC-'||(GEN_ADTOCM.nextval);
  ...
  END;
   ...
   INSERT INTO PDUPREC
    ...
    VALUES(:NEW.ESTAB, 1, :NEW.NUMEROCM, 'ACB-'||(GEN_ADTOCM.nextval), :NEW.DTMOVTO,
    V_VALOR, 19,11,'N',:NEW.MOEDA, :NEW.VENCIMENTO,'ACB-'||(GEN_ADTOCM.nextval),V_VALOR,
    'REF:'||:NEW.HISTORICO||''||:NEW.HISTORICO2,4, 30, 'N',:NEW.USERID, :NEW.VENCIMENTO,1,'N',:NEW.ESTAB||:NEW.NUMEROCM||:NEW.SEQCM );
     END IF; 
